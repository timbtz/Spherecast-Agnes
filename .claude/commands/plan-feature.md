...
- Find relevant documentation in docs/, ai_docs/, Orchestration/References/ or ai-wiki if available
...
**Filename**: `Orchestration/Plans/{kebab-case-descriptive-name}.md`

- Replace `{kebab-case-descriptive-name}` with short, descriptive feature name
- Examples: `add-user-authentication.md`, `implement-search-api.md`, `refactor-database-layer.md`

**Directory**: `Orchestration/Plans/` (already exists — do not recreate)
