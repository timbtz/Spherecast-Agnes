...
| 306 | Vegetable Magnesium Stearate | 4 | 4 | 0 | Ashland | 0.402 | 3 |
...
**Decision:** `refuse_gate_fail`  •  **Confidence:** 18%
...
**Why we refused**
- refuse_gate_fail at compound confidence 18%.
...
- candidates evaluated: 4
- decision breakdown: {'defer_human_review': 4}
- top-5 ranked suppliers:
  - **Ashland** (id 5) — score `0.402` · Q=0.50 C=0.50 L=0.50 R=0.15
  - **Colorcon** (id 11) — score `0.402` · Q=0.50 C=0.50 L=0.50 R=0.15
  - **Ashland** (id 5) — score `0.402` · Q=0.50 C=0.50 L=0.50 R=0.15
  - **Colorcon** (id 11) — score `0.402` · Q=0.50 C=0.50 L=0.50 R=0.15
- drafted RFQs: [19, 20, 21]
...
- recommend / human-review: 4

- refused: 0

- top-supplier score: 0.402
...
**Decision:** `defer_human_review`  •  **Confidence:** 51%
**Jurisdictions evaluated:** US-FDA, EU
...
- Baseline regulatory check passes, but incumbent precedent is ambiguous.
- A buyer should sign off before this enters an RFQ.
