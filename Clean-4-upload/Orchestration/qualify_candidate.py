...
def qualify_candidate(
    ...
    #
    # Pass the live sqlite connection into GateEngine so the canonical
    # gate's curated-substitution fallback can fire for equivalent /
    # partial edges that Tim's substitution_graph materialized into
    # Ingredient_Substitution. Without conn, the gate is strictly
    # identity-based and rejects every sodium-ascorbate-for-ascorbic-acid
    # pair as "no_canonical_match".
